...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getwidgets
        Button takeImage = (Button) findViewById(R.id.button_image_capture);
        buttonSave = (Button) findViewById(R.id.button_image_save);
        Button buttonLoad = (Button) findViewById(R.id.button_image_load);
